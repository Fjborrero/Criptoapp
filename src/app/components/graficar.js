...
export function Graficar() {
    ...
    const peticionDbBitcoin = async()=>{
        ...
        .then(response=>{
            ...
            respuesta.map(elements=>{
                pricesAux.push(elements.price);
                last_updateAux.push(new Date(elements.date_price).toLocaleTimeString());
            });
    ...
    const peticionDbEthereum = async()=>{
        ...
        .then(response=>{
            ...
            respuesta.map(elements=>{
                pricesAuxEthereum.push(elements.price);
  ...
  <div className="chart" >
    ...
    <Line options={options} data={data} className='grafica' /> 
